...
const AdminUsuarios = () => {
  ...
  useEffect(() => {
    ...
    if (parquesCodigo === 0) {
      ...
      Data = usuariolista?.filter(U => U.ParqueId === parquesCodigo)
    }
    setUsuariodetalle({ Data })
    // eslint-disable-next-line
  }, [parquesone, usuariolista, parquesCodigo]);
  ...
  return (
    <CRow>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
                ...
                <>
                  <CNavItem
                    ...
                    <CNavLink
                      ...
                      onClick={() => handleChangeParque(item.ParqueId, index + 1)}
                    >{item.NombreParque}
                    </CNavLink>
                  </CNavItem>
                </>
            ...
            <CTabContent>
              {parques?.map((item, index) => (
                <>
                  <CTabPane key={index} role="tabpanel" aria-labelledby="home-tab" visible={activeKey === index + 1}>
                    <CForm key={index}>
                      <CTable align="middle" className="mb-0 border" hover responsive>
                        ...
                        <CTableBody>
                          ...
                          usuariodetalle?.Data?.filter(U => U.Perfil.CodigoPerfil !== 0).map((item, index) => (
                            <CTableRow v-for="item in tableItems" key={index}>
                              ...
                              <CTableDataCell>
                                ...
                                <div className="small text-medium-emphasis">
                                  <span>{item.TipoUsuario.NombreTipoUsuario}</span> | <span> C.C {item.Documento}</span>
                                </div>
                              </CTableDataCell>
                              ...
                              <CTableDataCell>
                                <div className="small text-medium-emphasis">
                                  <CTooltip
                                    content="Reiniciar Clave Usuario."
                                    placement="bottom"
                                  >
      ...
      <AdminUsuariosModalCrear
          ...
          parquesCodigo={parquesCodigo}
          parquesone={parquesone}
        />
